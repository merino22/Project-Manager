...
app.get("/users/adm_employeeAct",checkNotAuthenticated, async(req, res)=>{
    ...
    ORDER BY emp.id_emp`);
    res.render("adm_employeeAct", {activities: activities.rows});
});
...
app.get("/users/adm_employees", checkNotAuthenticated, async(req, res)=>{
    ...
    res.render("adm_employees", { employees: employees.rows, teams: teams.rows, jobs: jobs.rows, habs: habilities.rows});
})
...
app.get("/users/adm_employeeJobs", checkNotAuthenticated, async(req,res)=>{
    ...
    ORDER BY emp.id_emp`)
    res.render("adm_employeeJobs", { jobs: jobs.rows});
})

app.post("/formhab", checkNotAuthenticated, async(req, res)=>{
...
app.get("/users/adm_activity_req", checkNotAuthenticated, async(req, res)=>{
    ...
    res.render("adm_activity_req", { requests: requests.rows});
})
